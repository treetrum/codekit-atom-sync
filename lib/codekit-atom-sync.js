...
export default {
    ...
    activate(state) {
        ...
        this.modalPanel = atom.workspace.addModalPanel({item: this.codekitAtomSyncView.getElement(), visible: false});
    ...
    serialize() {
        return {codekitAtomSyncViewState: this.codekitAtomSyncView.serialize()};
    },
